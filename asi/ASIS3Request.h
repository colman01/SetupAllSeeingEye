...
@interface ASIS3Request : ASIHTTPRequest <NSCopying, NSXMLParserDelegate> {
    ...
    // The content type for PUT requests, will default to 'application/json' when PUTing data
    NSString *contentType;
    
    // The request URI on the server
    NSString *uri;
    
    // Additional query parameters, default null
    NSString *parameters;
}
//new
